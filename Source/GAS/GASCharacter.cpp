...
#include "Public/Core/Components/GASAbilitySystemComponent.h"
...
AGASCharacter::AGASCharacter()
{
	...
	AbilitySystemComponent = CreateDefaultSubobject<UGASAbilitySystemComponent>("AbilitySystem Component");
